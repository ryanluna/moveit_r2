...
#ifndef R2_KDLCHAINIKSOLVERPOS_NR_JL_Mimic_HPP
#define R2_KDLCHAINIKSOLVERPOS_NR_JL_Mimic_HPP
...
public:
  ...
  bool setMimicJoints(const std::vector<r2_kdl_kinematics_plugin::JointMimic>& mimic_joints);
...
private:
  ...
  double eps;
  std::vector<r2_kdl_kinematics_plugin::JointMimic> mimic_joints;
