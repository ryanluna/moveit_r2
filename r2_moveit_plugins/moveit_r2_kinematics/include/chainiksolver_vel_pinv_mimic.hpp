...
#ifndef R2_KDL_CHAIN_IKSOLVERVEL_PINV_Mimic_HPP
#define R2_KDL_CHAIN_IKSOLVERVEL_PINV_Mimic_HPP
...
public:
   ...
   */
  bool setMimicJoints(const std::vector<r2_kdl_kinematics_plugin::JointMimic> &_mimic_joints);
...
private:
  ...
  std::vector<r2_kdl_kinematics_plugin::JointMimic> mimic_joints_;
